...
// for my projects page just need to add delete button with the project card you can use any card you want or publisher wala card and just iterate over using map done scene
const Dashboard = () => {
