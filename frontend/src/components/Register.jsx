     ...
     py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl w-full bg-secCo p-8 rounded-lg shadow-md flex">
        <div className="w-3/5 pr-4">
          <h2 className="text-3xl font-extrabold text-gray-900 mb-6">Create a new account</h2>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <div className='mt-4'>
                <a href="/">Already have an account ? <span className='text-blue-600'>Login</span></a>
                </div>
            </div>
          </form>
        </div>
